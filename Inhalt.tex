...
\section{Ist-Analyse}
Wie in Sektion \ref{Projektabgrenzung} (Projektabgrenzung) schon angedeutet ist der Hauptcontroller, sowie alle Animationscontroller und Hilfsklassen wie unter anderem die Kamerabewegung, ein Arduino\fcitetitle{Arduino} Kommunikationsscript bereits in das Projekt eingebunden. 
